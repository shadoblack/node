...
const app       = express();
const {arrayProfesionales} = require("./IMDB/clases/professional.js");
...
response.send(respuesta);
        ...
        {
            respuesta = {mensaje: "No existe ningun actor llamado asi"};
            response.send(respuesta);
        }
    });

    app.delete("/deleteProfesional",
    function(request,response)
    {
        let respuesta
        if (profesional != null)
